	...
	\begin{cjsection}{}
		\cjitem{Find the solution set of the following equations.}
			...
			\cjsubitem{\(\frac{2x + 3}{4} - \frac{x - 1}{2} = -\frac{1}{3}\)}
				\begin{cjsolution}
					\cjwhy{\(\frac{3(2x + 3)}{12} - \frac{6(x - 1)}{12} = -\frac{4}{12}\)}{LCM = \(12\)}
			...
			\cjsubitem{\(3x^2 - 2x + 1 = 0\)}
				\begin{cjsolution}
					...
					\cjfa{\(x \in \{\frac{1}{3} + \frac{\sqrt{2}}{3}i, \frac{1}{3} - \frac{\sqrt{2}}{3}i\}\)}
				\end{cjsolution}
			...
			\cjsubitem{\(\frac{x}{x - 1} + \frac{x - 5}{x^2 + 2x - 3} = \frac{1}{x + 3}\)}
				\begin{cjsolution}
					...
					\cjsubwhy{\(\frac{x(x + 3)}{(x - 1)(x + 3)} + \frac{x - 5}{(x - 1)(x + 3)} = \frac{x - 1}{(x - 1)(x + 3)}\)}{LCM = \((x - 1)(x + 3)\)}
					\cjcontinue{\(\frac{x^2 + 3x}{(x - 1)(x + 3)} + \frac{x - 5}{(x - 1)(x + 3)} = \frac{x - 1}{(x - 1)(x + 3)}\)}
					\cjsubwhy{\(x^2 + 3x + x - 5 = x - 1\)}{Eliminate denominator. \(x \in \{-3, 1\}\) are undefined points.}
					\cjcontinue{\(x^2 + 3x + x - 5 - x + 1 = 0\)}
					\cjcontinue{\(x^2 + 3x - 4 = 0\)}
					\cjsubwhy{\((x + 4)(x - 1) = 0\)}{Factor by grouping.}
					\cjfastep{\(x = -4\)}{Discard undefined point \(x = 1\).}
				\end{cjsolution}
		...
		\cjitem{Find all real values of \(k\) such that the equation \(x^2 + kx + k = x - 2\) has exactly one solution.}
			\begin{cjsolution}
				...
				\cjsubwhy{\((k - 7)(k + 1) = 0\)}{Factor by grouping.}
				\cjfa{\(k \in \{-1, 7\}\)}
			\end{cjsolution}
	\end{cjsection}
\end{document}
