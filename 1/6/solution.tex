	...
	\begin{cjsection}{}
		...
		the vertices of the ellipse \(4{(x - 2)}^2 + {(y + 1)}^2 = 1\)}.
			\begin{cjsolution}
				...
				\cjsubwhy{\(V_1 = (2, -2)\)}{\(V_1 = (h, k - b)\) for ellipses with a vertical major axis.}
				\cjsubwhy{\(V_2 = (2, 0)\)}{\(V_2 = (h, k + b)\) for ellipses with a vertical major axis.}
				\cjwhy{\(V = (2, 0), F = (2, -2)\)}{Derive the vertex and focus. Since this is a parabola opening downward, the lower point is the focus.}
				\cjsubwhy{\(0 + p = -2\)}{Derive \(p\); \(F = (h, k + p)\) for parabolas opening downward.}
				\cjcontinue{\(p = -2\)}
