...
\begin{document}
	...
	\begin{cjsection}{Solve for \(x\)}
		...
		\cjitem{\(x^2(x^2 - 1) - 9(x^2 - 1) = 0\)}
			\begin{cjsolution}
				\cjwhy{\((x^2 - 9)(x^2 - 1) = 0\)}{Factor by grouping.}
				\cjwhy{\(x^2 - 9 = 0\)}{Solve for x.}
				\cjsubwhy{\((x - 3)(x + 3) = 0\)}{Factor using difference of two squares.}
				\cjcontinue{\(x \in \{-3, 3\}\)}
				\cjwhy{\(x^2 - 1 = 0\)}{Solve for x.}
				\cjsubwhy{\((x - 1)(x + 1) = 0\)}{Factor using difference of two squares.}
				\cjcontinue{\(x \in \{-1, 1\}\)}
				\cjfa{\(x \in \{-3, -1, 1, 3\}\)}
			\end{cjsolution}

		\cjitem{\(2(x^2 + x + 1) + \sqrt{x^2 + x + 1} - 3 = 0\)}
			\begin{cjsolution}
				\cjwhy{\(2t + \sqrt{t} - 3 = 0\)}{\(t = x^2 + x + 1\)}
				\cjsubwhy{\(2t - 3 = \sqrt{t}\)}{Isolate the root.}
				\cjsubwhy{\({(2t - 3)}^2 = t\)}{Square both sides.}
				\cjcontinue{\(4t^2 - 12t + 9 = t\)}
				\cjcontinue{\(4t^2 - 13t + 9 = 0\)}
				\cjsubwhy{\(4t^2 - 4t - 9t + 9 = 0\)}{Factor by grouping.}
				\cjcontinue{\(4t(t - 1) - 9(t - 1) = 0\)}
				\cjcontinue{\((4t - 9)(t - 1) = 0\)}
				\cjcontinue{\(t \in \{1, \frac{9}{4}\}\)}
				\cjwhy{\(x^2 + x + 1 = 1\)}{Solve for \(x\) using \(t = 1\).}
				\cjcontinue{\(x^2 + x = 0\)}
				\cjcontinue{\(x(x + 1) = 0\)}
				\cjcontinue{\(x \in \{-1, 0\}\)}
				\cjwhy{\(x^2 + x + 1 = \frac{9}{4}\)}{Solve for \(x\) using \(t = \frac{9}{4}\)}
				\cjcontinue{\(x^2 + x + 1 - \frac{9}{4} = 0\)}
				\cjcontinue{\(x^2 + x + \frac{4}{4} - \frac{9}{4} = 0\)}
				\cjcontinue{\(x^2 + x - \frac{5}{4} = 0\)}
				\cjcontinue{\(4x^2 + 4x - 5 = 0\)}
				\cjsubwhy{\(\frac{-4 \pm \sqrt{4^2 - 4(4)(-5)}}{2(4)}\)}{Use the quadratic formula.}
				\cjcontinue{\(\frac{-4 \pm \sqrt{16 - 4(4)(-5)}}{2(4)}\)}
				\cjcontinue{\(\frac{-4 \pm \sqrt{16 + 80}}{8}\)}
				\cjcontinue{\(\frac{-4 \pm \sqrt{96}}{8}\)}
				\cjcontinue{\(\frac{-4 \pm \sqrt{16}\sqrt{6}}{8}\)}
				\cjcontinue{\(\frac{-4 \pm 4\sqrt{6}}{8}\)}
				\cjcontinue{\(\frac{-1 \pm \sqrt{6}}{2}\)}
				\cjcontinue{\(x \in \{\frac{-1 + \sqrt{6}}{2}, \frac{-1 - \sqrt{6}}{2}\}\)}
				\cjwhy{\(2({(-1)}^2 - 1 + 1) + \sqrt{{(-1)}^2 - 1 + 1} - 3 = 0\)}{Verify \(x = -1\)}
				\cjcontinue{\(2(1 - 1 + 1) + \sqrt{1 - 1 + 1} - 3 = 0\)}
				\cjcontinue{\(2(1) + \sqrt{1} - 3 = 0\)}
				\cjcontinue{\(2 + 1 - 3 = 0\)}
				\cjcontinue{\(0 = 0\)}
				\cjcontinue{\(x = -1\)}
				\cjwhy{\(2(0^2 - 0 + 1) + \sqrt{0^2 - 0 + 1} - 3 = 0\)}{Verify \(x = 0\)}
				\cjcontinue{\(2(1) + \sqrt{1} - 3 = 0\)}
				\cjcontinue{\(2 + 1 - 3 = 0\)}
				\cjcontinue{\(0 = 0\)}
				\cjcontinue{\(x = 0\)}
				\cjfastep{\(x \in \{-1, 0\}\)}{A quadratic equation can have at most two solutions.}
			\end{cjsolution}
	\end{cjsection}
\end{document}
